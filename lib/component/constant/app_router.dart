...
final GlobalKey<NavigatorState> myNavigatorKey =
    GlobalKey<NavigatorState>(debugLabel: 'my');
      ...
      StatefulShellBranch(
        ...
        routes: <RouteBase>[
          GoRoute(
            ...
            pageBuilder: (BuildContext context, GoRouterState state) {
              return const NoTransitionPage<void>(child: MessagePage());
            },
          ),
        ],
      ),
      StatefulShellBranch(
        ...
        routes: <RouteBase>[
          GoRoute(
            ...
            pageBuilder: (BuildContext context, GoRouterState state) {
              return const NoTransitionPage<void>(
                key: ValueKey<String>(MyPage.name),
                child: MyPage(),
              );
            },
            // routes: <RouteBase>[
