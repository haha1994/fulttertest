...
import '../../component/adaptive/adaptive_select_tile.dart';
import '../../component/constant/language_codes.dart';
    ...
    return SectionCardWithHeading(
      ...
      children: [
        ...
        AdaptiveSelectTile<Locale>(
          ...
          secondary: const Icon(SystemIcons.language),
          options: [
            DropdownMenuItem(
        ...
        //   secondary: const Icon(SystemIcons.shoppingBag),
